    ...
    return (
        <section className={ styles.Intro }>
            ...
            <div className={ styles.IntroSection }>
                ...
                <p>I consider myself a student of the craft. I keep myself updated with current trends. I dedicate at least an hour a day to study a new language or master my current set of skills.</p>
