    ...
    return (
        <section className={ styles.Intro }>
            ...
            <div className={ styles.IntroSection }>
                <p>Hello. I am Ruel, a Full-stack Developer based in Brooklyn, New York. I love building applications and tend to gather inspiration based on the experiences of friends and relatives.</p>
                ...
                <p>I am also capable of doing Back-end development using Ruby and Ruby on Rails. I am also currently learning Python, Node.js, and Java since after mastering Front-end development, I would love to transition towards Back-end development a lot more. </p>
            </div>
        </section>
    );
}
